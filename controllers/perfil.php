        ...
        if(isset($_POST['ingresar'])){
            ...
            if($contrasenaactual==NULL | $contrasenanueva==NULL | $contrasenanuevaconfirmado==NULL ){
                $this->view->mensaje = '
                    <div class="col-md-6 mx-auto alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        <font color="#338AFF"><p align="center"><b>Ingrese los datos en los campos</b></p></font>
                    </div>         
                ';
            }elseif(($this->model->getcontrasena(['identificacion' => $identificacion])) != $contrasenaactualencrip){
                $this->view->mensaje = '
                    <div class="col-md-6 mx-auto alert alert-danger alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <font color="#338AFF"><p align="center"><b>La contraseña que ingresó no coincide con el que está en el sistema</b></p></font>
                    </div>             
                ';
                ...
                $this->view->mensaje = '
                    <div class="col-md-6 mx-auto alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        <font color="#338AFF"><p align="center"><b>Las contraseñas que ingresó no coinciden</b></p></font>
                    </div>         
                ';
            }else{
                if($this->model->actualizarinformacioncontrasena(['contrasena'=> $contrasenanuevaencrip,'identificacion'=> $identificacion])){
                    ...
                    <div class="col-md-6 mx-auto alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <font color="#338AFF"><p align="center"><b>Contraseña actualizada correctamente</b></p></font>
                    </div>                
                ';
                }
            } 
            ...
            $this->view->mensaje = '
                <div class="col-md-6 mx-auto alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <font color="#338AFF"><p align="center"><b>Utilice el formulario</b></p></font>
                </div>         
            ';
        }
        $this->render();
